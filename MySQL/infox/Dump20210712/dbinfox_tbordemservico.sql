...
CREATE TABLE `tbordemservico` (
  ...
  PRIMARY KEY (`os`),
  KEY `idcli` (`idcli`),
  CONSTRAINT `tbordemservico_ibfk_1` FOREIGN KEY (`idcli`) REFERENCES `tbclientes` (`idcli`)
...
INSERT INTO `tbordemservico` VALUES (2,'2021-07-12 19:25:11','Notebook','nao liga','troca da fonte','ze',87.59,1);
...
-- Dump completed on 2021-07-12 16:40:13
